...
<section class="content">
	<div class="box box-primary">
		...
		<div class="box-body">
			<form action="{{url('/linea/store')}}" class="form-horizontal" method = "post" enctype="multipart/form-data" autocomplete="off">
				{!! csrf_field() !!}
				<div class="form-group">

					<div class="form-group {{ $errors->has('procesos') ? 'has-error' : ''}}">
						    {!! Form::label('procesos', 'Nombre de la Linea Proceso', ['class' => 'col-md-4 control-label']) !!}
						    <div class="col-md-6">
