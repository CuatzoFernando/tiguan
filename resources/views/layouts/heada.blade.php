...
<script src="{{ asset('js/Afos/Afos.js') }}" charset="utf-8"></script>
<script src="{{ asset('js/Afos/Editar.js') }}" charset="utf-8"></script>
<script src="{{ asset('js/Afos/Lineas.js') }}" charset="utf-8"></script>
<script src="{{ asset('js/Afos/Padres.js') }}" charset="utf-8"></script>
<script src="{{ asset('js/Afos/dropdown.js') }}" charset="utf-8"></script>
