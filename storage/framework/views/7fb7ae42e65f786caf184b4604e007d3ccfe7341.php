<?php echo Form::open(['url' => '/Administracion/documentos/storeT',
                'autocomplete' => 'off',
                'files' => true]); ?>
...
-->
  ...
  <div class="form-group <?php echo e($errors->has('procesos') ? 'has-error' : ''); ?>">
          ...
          <div class="col-md-6">
            <select class="form-control input-sm" name="procesos" id="procesosT">
              <option value=""></option>
  ...
  <div class="form-group <?php echo e($errors->has('lineas') ? 'has-error' : ''); ?>">
          ...
          <div class="col-md-6">
            <select class="form-control input-sm" name="lineas" id="lineasT">
              <option value=""></option>
            </select>
  ...
  <div class="form-group <?php echo e($errors->has('NOMBREPADRE') ? 'has-error' : ''); ?>">
          ...
          <div class="col-md-6">
            <select class="form-control input-sm" name="NOMBREPADRE" id="NOMBREPADRECT">
              <option value=""></option>
            </select>
